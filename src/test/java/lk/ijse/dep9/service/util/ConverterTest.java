...
class ConverterTest {
    ...
    void toMemberDTO() {
        Faker faker = new Faker();
        Member memberEntity = new Member(UUID.randomUUID().toString(), faker.name().fullName(), faker.address().
                fullAddress(), faker.regexify("0\\d{2}-\\d{7}"));
    ...
    void toMember() {
        Faker faker = new Faker();
        MemberDTO memberDTO = new MemberDTO(UUID.randomUUID().toString(), faker.name().fullName(), faker.address().
                fullAddress(), faker.regexify("0\\d{2}-\\d{7}"));
    ...
    void toIssueNote() {
        ...
        ArrayList<String> books = new ArrayList<>(Arrays.asList("1234-1234", "1111-2222"));
        IssueNoteDTO issueNoteDTO = new IssueNoteDTO(1, LocalDate.now(), UUID.randomUUID().toString(), books);
